...
2. Verifique que o output contract da fase atual está completo:
   - Fase 0 (briefing): `.harness/brief.md` existe e tem ≥5 linhas
   - Fase 1 (docs): `AGENTS.md`, `ARCH.md`, `RAG/index.json` (≥3 docs)
   - Fase 2 (requisitos): `PRD.md` + `SPEC.md` (scores via reviewers)
   - Fase 3 (design): `PRODUCT.md` + `design/*.DESIGN.md` + `design/*.PROMPT.md`
   - Fase 4 (planejamento): `.harness/sprints/index.json` + `.harness/sprints/S*.json` + `.harness/sprints/cross-sprint.json`
